...
public class Key extends TestActor{

	public boolean visible;
	public static float width =64/2 * World.WORLD_UNIT;
	public static float height = 31/2 * World.WORLD_UNIT;
	
	//VARIABLES FOR TRACKING THE LIFE TIME OF THE EGGS
	private float startTime = System.nanoTime();
	public static float SECONDS_TIME = 0;
	
	public Key(float width, float height, boolean DIPActive) {
